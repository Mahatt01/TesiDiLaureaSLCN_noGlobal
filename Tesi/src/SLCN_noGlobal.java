 ...
 *
 */
public class SLCN_noGlobal implements MultiLabelLearner{
	...
	public SLCN_noGlobal() throws FileNotFoundException {
		this(new J48());
	}
	
	public SLCN_noGlobal(AbstractClassifier classifier) throws FileNotFoundException {
		this.classifier = classifier;
	}
	
	public SLCN_noGlobal(AbstractClassifier classifier, int maxAttributes, int maxTrainSampleSize) throws FileNotFoundException {
		this(classifier);
		this.maxLocalAttributes = maxAttributes;
		this.maxTrainSampleSize = maxTrainSampleSize;
	}
	
	public SLCN_noGlobal(AbstractClassifier classifier, int maxLocalAttributes, int maxGlobalAttributes, int maxTrainSampleSize) throws FileNotFoundException {
		this(classifier);
	...
	public SLCN_noGlobal(AbstractClassifier classifier, int maxLocalAttributes, int maxTrainSampleSize, double biasToUniformClass) throws FileNotFoundException {
		this(classifier, maxLocalAttributes, maxTrainSampleSize);
		setBiasToUniformClass(biasToUniformClass);
	}
	
	public SLCN_noGlobal(AbstractClassifier classifier, int maxLocalAttributes, int maxGlobalAttributes,int maxTrainSampleSize, double biasToUniformClass) throws FileNotFoundException {
	...
	public MultiLabelLearner makeCopy() throws Exception {
		SLCN_noGlobal copy = new SLCN_noGlobal(classifier, maxLocalAttributes, maxGlobalAttributes, maxTrainSampleSize, biasToUniformClass);
